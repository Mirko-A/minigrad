...
class TestValue(unittest.TestCase):
    def test_add_two_value_objects(self):
        ...
        v1 = Value(a)
        v2 = Value(b)
        self.assertEqual((v1 + v2).item(), a + b)

    def test_add_value_object_and_scalar(self):
        a = 3.0
        b = 1.5
        v1 = Value(a)
        self.assertEqual((v1 + b).item(), a + b)

    def test_add_scalar_and_value_object(self):
        a = 3.0
        b = 1.5
        v1 = Value(a)
        self.assertEqual((b + v1).item(), a + b)
    ...
    def test_sub_scalar_and_value_object(self):
        ...
        b = 1.5
        v1 = Value(a)
        self.assertEqual((b - v1).item(), b - a)

    def test_neg_value_object(self):
        a = 3.0
        v1 = Value(a)
        self.assertEqual(-v1.item(), -a)
    ...
    def test_div_scalar_and_value_object(self):
        a = 3.0
        v1 = Value(a)
        self.assertEqual((1 / v1).item(), 1 / a)
    ...
    def test_exp(self):
        a = 3.0
        v1 = Value(a)
        self.assertEqual((math.e ** v1).item(), math.e ** a)
        
    def test_sigmoid(self):
        a = 3.0
        v1 = Value(a)
        self.assertEqual((v1.sigmoid()).item(), 1 / (1 + math.e ** -a))
    ...
    def test_relu_below_zero(self):
        ...
        a_relu = 0
        v1 = Value(a)
        self.assertEqual((v1.relu()).item(), a_relu)
