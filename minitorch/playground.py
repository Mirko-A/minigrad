...
# print(type(True))
# loss = nn.MSELoss()
# input = torch.tensor([[43.6, 44.4, 45.2, 46.0, 46.8], [32.4, 31.9, 28.6, 39.1, 40.2], [40.8, 52.1, 33.8, 51.7, 60.3]])
# input.requires_grad = True
# other = torch.tensor([[41.0, 30.0, 42.0], [45.0, 35.0, 50.0], [49.0, 28.0, 35.0], [47.0, 37.0, 54.0], [44.0, 39.0, 59.0]])
# other.requires_grad = True
# target = torch.tensor([[41.0, 45.0, 49.0, 47.0, 44.0], [30.0, 35.0, 28.0, 37.0, 39.0], [42.0, 50.0, 35.0, 54.0, 59.0]])
...
input = torch.tensor([[ 0.7,  3.2, 1.1], 
                      [ 3.2, -3.9, 0.2], 
                      [-1.5,  3.2, 3.2]])

target = torch.tensor([[ 1.7, 2.2, 1.6], 
                       [ 2.2, 3.9, 0.4], 
                       [-1.6, 0.2, 2.2]])
